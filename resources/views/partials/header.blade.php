        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="collapsibleNavId">
                <ul class="navbar-nav me-auto mt-2 mt-lg-0">
                    <li class="nav-item">
                        <a class="nav-link text-uppercase" href="{{route('home')}}">CHARACTERS</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link text-uppercase" href="{{route('comics')}}">COMICS</a>
                    </li>
                    <li class="nav-item">
                    ...
                    <li class="nav-item dropdown">
                        <a class="nav-link text-uppercase dropdown-toggle" href="#" id="dropdownId" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">SHOP</a>
